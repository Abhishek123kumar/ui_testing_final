        ...
        <div className='bg-white w-[100%] fixed top-0 z-10 shadow-md '>
            <div className='container w-[100%] px-[30px] py-4 mx-auto flex items-center justify-between'>
                ...
                <div className=' flex justify-center item-center'>
                    {localStorage.getItem("token") !== null ? <button className='rounded-md px-3 py-[3px] text-[18px] font-bold  bg-[#ff4343]  text-white' onClick={()=>{localStorage.removeItem("token");navigate("/")}} >LogOut</button> :
